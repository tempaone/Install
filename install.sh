...
if [[ $(lsb_release -si) == "Debian" ]]; then
	...
	wget -qN https://raw.githubusercontent.com/tempaone/Install/master/source/ansible-debian-ansible.list /etc/apt/sources.list.d/
...
##fast change the editions
echo -ne '#######                   (30%)\r'
git clone -b $edition --single-branch https://github.com/tempaone/Install.git /opt/pgstage 1>/dev/null 2>&1
git clone https://github.com/tempaone/PTS-Update.git /opt/ptsupdate 1>/dev/null 2>&1
echo -ne '##########                (40%)\r'
